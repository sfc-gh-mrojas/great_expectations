...
class SnowparkDataSampler(DataSampler):
    """Methods for sampling a Snowpark dataframe."""

    def sample_using_limit(
        self, df: snowpark.DataFrame, batch_spec: BatchSpec
    ) -> snowpark.DataFrame:
        ...
        try:
            ...
            raise (
                gx_exceptions.ExecutionEngineError(
                    f"""The sampling method used with SnowparkDFExecutionEngine has a reference to an invalid hash_function_name.
